...
However, at this point a much better alternative would be going for Broadcom BCM94352HMB module. Although it would need BIOS Wi-Fi whitelist [bypass hack](../README.md#defeating-30s-series-wi-fi-whitelist) and a [hardware mod](../README.md#hardware-mod) on a card itself, it would allow you to bump installed macOS version to Monterey, which offers better compatibility with software.
